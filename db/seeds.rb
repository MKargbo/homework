...
Book =Book(id: integer, title: string, author: string, price: integer)
...
Review =Review(book_id: integer, rating: integer, review: string)

Review.delete_all
Review.create("book_id" => orphan.id, "rating" => 5, "review" => "Riveting!")
Review.create("book_id" => orphan.id, "rating" => 2, "review" => "About as dull as you can get.")
Review.create("book_id" => orphan.id, "rating" => 3, "review" => "Not bad.")
Review.create("book_id" => shadow.id, "rating" => 4, "review" => "Great book and not too many pages.")
Review.create("book_id" => shadow.id, "rating" => 4, "review" => "Excellent font and margins. Story wasn't bad, either.")
Review.create("book_id" => shadow.id, "rating" => 4, "review" => "Worth reading when there isn't a hockey game on.")
Review.create("book_id" => shadow.id, "rating" => 1, "review" => "Didn't understand it at all.")
Review.create("book_id" => alchemist.id, "rating" => 2, "review" => "I thought this was about how to make gold?")
Review.create("book_id" => alchemist.id "rating" => 4, "review" => "Suspensful plot, good characters.")
Review.create("book_id" => alchemist.id "rating" => 5, "review" => "Perfect. A work of art.")
Review.create("book_id" => alchemist.id "rating" => 3, "review" => "Kind of confusing.")
